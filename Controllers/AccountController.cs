...
namespace web_banmaytinh.Controllers
{
    public class AccountController : Controller
    {
        // GET: Account

        private QL_CuaHangMayTinhEntities data = new QL_CuaHangMayTinhEntities();
        ...
        public ActionResult Login(string Email, string Password)
        {
            ...
            var user2 = data.NHANVIENs.FirstOrDefault(u => u.EMAIL == Email && u.PASSWORD == Password);
            if (user != null)
            {
            ...
            {
                Session["UserID"] = user2.MANV;
                Session["Email"] = user2.EMAIL;
                Session["Role"] = user2.VAITRO;
                
               
                    return RedirectToAction("Index", "Home"); // Điều hướng đến trang Home nếu không phải Admin
